...
class _Home extends State<Home> {
  ...
  void _playVoiceAndNavigate(BuildContext context, String audioPath, bool isBoy, String categoryName )  async {
    _player?.dispose();
    _player = AudioPlayer();
    ...
    Future.delayed(const Duration(seconds: 2), () {
        Navigator.push(
                    context,
                    MaterialPageRoute(builder: (context) => CategoryPage(isBoy: isBoy, categoryName: categoryName)),
                  );
    });
  }
          ...
          children: [
            SizedBox(
              ...
              child: MyBtn(
                ...
                buttonText: 'حاب',
                onPressed: () {
                  _playVoiceAndNavigate(context, '1.wav', widget.isBoy, 'want');
                },
            ...
            SizedBox(
              ...
              child: MyBtn(
                ...
                buttonText: 'نتعلم',
                onPressed: () {
                 _playVoiceAndNavigate(context, '1.wav', widget.isBoy, 'learn');
                },
                backgroundColor: getBtnColor(),
              ),
            ),
            ...
            SizedBox(
              ...
              child: MyBtn(
                ...
                buttonText: 'نحس',
                onPressed: () {
                  _playVoiceAndNavigate(context, '1.wav', widget.isBoy, 'feel');
                },
                backgroundColor: getBtnColor(),
              ),
            ),
